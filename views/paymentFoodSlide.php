<div class="payment-slide">
                ...
                <div class="orderManager">
                  ...
                  <li id="pending" onclick="window.location='../controller/orderCon.php?id=1'"><i style="width: 30px;"  class="fas fa-hourglass-half"></i> Pending Orders</li>
                  <li id="accept" onclick="window.location='../controller/orderCon.php?id=2'"><i style="width: 30px;" class="fas fa-clipboard-check"></i> Accepted Orders</li>
                  <li id="receive" onclick="window.location='../controller/orderCon.php?id=3'"><i style="width: 30px;" class="fas fa-truck"></i> Receiving Order</li>
