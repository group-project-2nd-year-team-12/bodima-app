<div class="payment-slide">
              <ul>
                  ...
                  <li id="order" onclick="window.location='../controller/orderConFood.php?id=1'"><i style="width: 30px;" class="fas fa-sort-amount-down-alt"></i> New Orders</li>
                  <li id="card" onclick="window.location='../controller/orderConFood.php?id=2'"><i style="width: 30px;"  class="far fa-credit-card"></i> Card Payment</li>
                  <li id="deliver" onclick="window.location='../controller/orderConFood.php?id=3'"><i style="width: 30px;" class="fas fa-truck"></i> Delivery List</li>
